...
Machine-independent configuration is done through bb.edn and hard-coded values
in the scripts under `scripts`. Not elegant, but sufficient at this scale.


Setup
-----

1. Install https://github.com/babashka/babashka/#installation.
2. Run:
...
1. Edit, lint and compile the code.
...
### Set the classpath for editing and compiling
    ...
    export CLASSPATH=$(bb run classpath --android-home=~/Android --app-home=~/Repos/MindEase/app)
...
Reinstallation of JavaScript files:
    ...
    bb run reinstall-js --app-home=~/Repos/MindEase/app
